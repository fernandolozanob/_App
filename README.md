...
The "Symfony Application Formation Support" is a reference application created to show how
to develop applications following the [Symfony Best Practices][1].

You can also learn about these practices in [the official Symfony Book][5].

<p align="center">
<a href="ressource/img.png">
</p>
...
```bash
# you can create a new project based on the Symfony project...
